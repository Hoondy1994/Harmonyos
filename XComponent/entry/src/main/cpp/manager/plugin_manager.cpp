...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback7777777777");
...
void PluginManager::RegisterLifecycle(napi_env env, napi_value exports, int64_t value)
{
    if ((nullptr == env) || (nullptr == exports)) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "PluginManager",
            "RegisterLifecycle: env or exports is null");
        return;
    }
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback8888888888");
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback9999999999");
