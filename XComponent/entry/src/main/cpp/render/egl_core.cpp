...
bool EGLCore::EglContextInit(void *window, int width, int height)
{
    ...
    if (!eglChooseConfig(m_eglDisplay, ATTRIB_LIST, &m_eglConfig, maxConfigSize, &numConfigs)) {
        ...
        // 获取配置属性并打印
    EGLint blueSize, greenSize, redSize, depthSize;
    eglGetConfigAttrib(m_eglDisplay, config, EGL_BLUE_SIZE, &blueSize);
    eglGetConfigAttrib(m_eglDisplay, config, EGL_GREEN_SIZE, &greenSize);
    eglGetConfigAttrib(m_eglDisplay, config, EGL_RED_SIZE, &redSize);
    eglGetConfigAttrib(m_eglDisplay, config, EGL_DEPTH_SIZE, &depthSize);
    
     OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "EGLCore", "Config attributes: Blue Size = %{public}d, Green Size = %{public}d, Red Size = %{public}d, Depth Size = %{public}d\n" ,blueSize, greenSize, redSize, depthSize);
   // printf("Config attributes: Blue Size = %d, Green Size = %d, Red Size = %d, Depth Size = %d\n",
     //      blueSize, greenSize, redSize, depthSize);
