...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback1111111111");
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback222222222222");
    if ((nullptr == component) || (nullptr == window)) {
        OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_PRINT_DOMAIN, "Callback",
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback333333333");
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback5555555555");
...
{
    OH_LOG_Print(LOG_APP, LOG_INFO, 0xFF00, "EGLAPP", "SDl begin to register callback444444444");
    this->m_id = id;
