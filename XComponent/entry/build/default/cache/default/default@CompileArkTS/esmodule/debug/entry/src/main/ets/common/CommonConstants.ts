...
export default class CommonConstants {
    ...
    /**
     * XComponent library name.
     */
    static readonly XCOMPONENT_LIBRARY_NAME: string = 'nativerender';
    /**
     * XComponent height.
     */
    static readonly XCOMPONENT_HEIGHT: string = '32.3%';
    /**
     * Button width.
     */
    static readonly BUTTON_WIDTH: string = '53.6%';
}
